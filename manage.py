...
from testregistration.app import create_app
from testregistration.database import db
from testregistration.settings import DevConfig, ProdConfig
from testregistration.user.models import User

CONFIG = ProdConfig if os.environ.get('TESTREGISTRATION_ENV') == 'prod' else DevConfig
